...
python start.py --job attack --dataset mnist --settype train --weighted false --firstindex 0 --lastindex 2
echo "Testing wjsma attack on mnist images from the train dataset"
python start.py --job attack --dataset mnist --settype train --weighted true --firstindex 0 --lastindex 2
echo "Testing jsma attack on mnist images from the test dataset"
python start.py --job attack --dataset mnist --settype test --weighted false --firstindex 0 --lastindex 2
echo "Testing wjsma attack on mnist images from the test dataset"
python start.py --job attack --dataset mnist --settype test --weighted true --firstindex 0 --lastindex 2
