...
-- dataset [mnist, cifar10, mnist-defense-jsma, mnist-defense-wjsma, mnist-defense-logattack]
-- settype [test, train]
-- attacktype [jsma, wjsma, logattack]
-- firstindex int
-- lastindex int
...
train (dataset)
test (dataset)
attack (dataset, settype, attacktype, firstindex, lastindex)
augment (settype, attacktype)
stats (dataset, settype, attacktype)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--attacktype', type=str, default="logattack")
    ...
    if args.job == "train":
        ...
        if args.attacktype != "logattack" and args.attacktype != "wjsma" and args.attacktype != "jsma":
            raise ValueError("attacktype argument is invalid")

        if args.dataset == "mnist":
            from attack.mnist.save_images_mnist import mnist_save_attacks

            mnist_save_attacks(args.attacktype, args.settype, args.firstindex, args.lastindex)
        elif args.dataset == "cifar10":
            from attack.cifar10.save_images_cifar10 import cifar10_save_attacks

            cifar10_save_attacks(args.attacktype, args.settype, args.firstindex, args.lastindex)
        elif args.dataset == "mnist-defense-jsma":
            from defense.mnist_defense_jsma.save_images_mnist_defense import mnist_defense_save_attacks

            mnist_defense_save_attacks(args.attacktype, args.settype, args.firstindex, args.lastindex)
        elif args.dataset == "mnist-defense-wjsma":
        ...
        generate_extra_set(args.settype, args.attacktype)
    elif args.job == "stats":
        if args.settype != "test" and args.settype != "train":
            raise ValueError("Invalid set type")
        ...
        if args.dataset == "mnist":
            if args.settype == "test":
                if args.attacktype == "jsma":
                    ...
                    average_stat("attack/mnist/logattack_test/")
            else:
                if args.attacktype == "jsma":
            ...
            if args.settype == "test":
                if args.attacktype == "jsma":
                    ...
                    average_stat("attack/cifar10/logattack_test/")
            else:
                if args.attacktype == "jsma":
                    ...
                    average_stat("attack/cifar10/logattack_train/")
        elif args.dataset == "mnist-defense-jsma":
            if args.settype == "test":
                if args.attacktype == "jsma":
                    ...
                    average_stat("defense/mnist_defense_jsma/logattack_test/")
            else:
                if args.attacktype == "jsma":
                    ...
                    average_stat("defense/mnist_defense_jsma/logattack_train/")
        elif args.dataset == "mnist-defense-wjsma":
            if args.settype == "test":
                if args.attacktype == "jsma":
                    ...
                    average_stat("defense/mnist_defense_wjsma/logattack_test/")
            else:
                if args.attacktype == "jsma":
                    ...
                    average_stat("defense/mnist_defense_wjsma/logattack_train/")
        elif args.dataset == "mnist-defense-logattack":
            if args.settype == "test":
                if args.attacktype == "jsma":
                    average_stat("defense/mnist_defense_logattack/jsma_test/")
                elif args.attacktype == "wjsma":
                    average_stat("defense/mnist_defense_logattack/wjsma_test/")
                else:
                    average_stat("defense/mnist_defense_logattack/logattack_test/")
            else:
                if args.attacktype == "jsma":
                    average_stat("defense/mnist_defense_logattack/jsma_train/")
                elif args.attacktype == "wjsma":
                    average_stat("defense/mnist_defense_logattack/wjsma_train/")
                else:
                    average_stat("defense/mnist_defense_logattack/logattack_train/")
        else:
            raise ValueError("Invalid dataset")
